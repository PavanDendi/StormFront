...
inner join member_hierarchy mh on mh.CHILD_ICA_CODE = c.ISS_CHILD_ICA_CODE and mh.PARENT_ICA_NAME = 'Parent ICA Name_337'
inner join month m on c.DW_PROCESS_MONTH = m.DW_PROCESS_MONTH
where m.Year_Qtr = '2020 Q1'
and cn.COUNTRY_NAME = 'TURKS AND CAICOS ISLANDS'
and c.ACQ_COUNTRY_CODE = c.ISS_COUNTRY_CODE
