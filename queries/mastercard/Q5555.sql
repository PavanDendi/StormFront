...
inner join member_hierarchy mh on mh.CHILD_ICA_CODE = c.ISS_CHILD_ICA_CODE and mh.PARENT_ICA_NAME = 'Parent ICA Name_237'
inner join month m on c.DW_PROCESS_MONTH = m.DW_PROCESS_MONTH
where m.Year = '2020'
and cn.COUNTRY_NAME = 'BAHAMAS'
and c.ISS_COUNTRY_CODE != c.ACQ_COUNTRY_CODE
group by m.Year_Qtr
, c.ACQ_TRANSIT_ROUTING_ID;