...
inner join country cn on cn.COUNTRY_CODE = c.ACQ_COUNTRY_CODE and cn.COUNTRY_CODE = 'MAR'
inner join month m on c.DW_PROCESS_MONTH = m.DW_PROCESS_MONTH and m.Year_Qtr in ('2020 Q1','2020 Q2')
inner join agg_merch ag on ag.MERCH_LOCATION_ID = c.MERCH_LOCATION_ID and ag.AGGREGATE_MERCHANT_NAME = 'Agg Merch _4323'
