select m.DW_PROCESS_MONTH, mcn.BUSINESS_REGION_NAME,  ag.AGGREGATE_MERCHANT_NAME
...
and cn.COUNTRY_CODE = 'GEO'
and ag.Industry_Name  = 'Cosmetics and Beauty Services'
and ag.AGGREGATE_MERCHANT_NAME =  'Agg Merch _9372'
group by m.DW_PROCESS_MONTH, mcn.BUSINESS_REGION_NAME, ag.AGGREGATE_MERCHANT_NAME;