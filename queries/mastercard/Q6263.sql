...
inner join member_hierarchy mh on mh.CHILD_ICA_CODE = c.ISS_CHILD_ICA_CODE and mh.PARENT_ICA_NAME = 'Parent ICA Name_317'
inner join month m on c.DW_PROCESS_MONTH = m.DW_PROCESS_MONTH
where m.DW_PROCESS_MONTH = '2020-01-01'
and cn.COUNTRY_NAME = 'VIRGIN ISLANDS, BRITISH'
